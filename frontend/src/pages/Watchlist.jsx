                ...
                <div className="p-4">
                  ...
                  <div className="flex gap-2 mt-4">
                    <button
                      ...
                      className="flex-grow bg-blue-500 text-white px-3 py-2 rounded text-sm sm:text-base hover:bg-blue-600 dark:hover:bg-blue-700 transition-colors"
                    >
                      {movie.watched ? 'Mark Unwatched' : 'Mark Watched'}
                    </button>
                    <button
                      onClick={() => handleRemoveMovie(movie.movieId)}
                      className="flex-grow bg-red-500 text-white px-3 py-2 rounded text-sm sm:text-base hover:bg-red-600 dark:hover:bg-red-700 transition-colors"
                    >
                      Remove
                    </button>
                  </div>
